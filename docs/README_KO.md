...
| | `list_institution_managers` | 적재된 SEC Form 13F manager 신원과 filing 커버리지 메타데이터 조회, 보유 종목은 제외 |
| | `get_institution_stock_holdings` | 한 manager의 지연된 SEC Form 13F 주식 보유 공시 조회 |
